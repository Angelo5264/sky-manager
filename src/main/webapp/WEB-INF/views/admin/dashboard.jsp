<%-- Document : dashboard Created on : 12 may 2026, 12:59:45 Author : maick --%>
                            ...
                            <div class="row mb-4">
                                <div class="col-md-3 mb-3">
                                    <div class="card stat-card">
                                        <div class="card-body d-flex align-items-center">
                                            <div
                                                class="stat-icon bg-primary bg-opacity-10 text-primary me-3 rounded p-3">
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="card stat-card">
                                        <div class="card-body d-flex align-items-center">
                                            <div
                                                class="stat-icon bg-success bg-opacity-10 text-success me-3 rounded p-3">
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="card stat-card">
                                        <div class="card-body d-flex align-items-center">
                                            <div
                                                class="stat-icon bg-warning bg-opacity-10 text-warning me-3 rounded p-3">
                                            ...
                                            <tbody>
                                                <c:forEach items="${recentBookings}" var="booking" varStatus="loop">
                                                    <c:if test="${loop.index < 5}">
                                                        <tr>
                                                            <td><span
                                                                    class="badge bg-secondary">${booking.codigoConfirmacion}</span>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <span
                                                                    class="badge bg-${booking.estadoReserva == 'CONFIRMADA' ? 'success' : 'danger'}">
                            ...
                            <div class="row">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="chart-container">
                                                <p class="text-muted">Grafico de ocupacion (requiere libreria de charts)
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="chart-container">
                                                <p class="text-muted">Grafico de ingresos (requiere libreria de charts)
                                                </p>
                                            </div>
                                        </div>
                                    </div>
