...
![pagina de descarga tomcat](ResourcesREADME/tomcat.png)
- Luego cen descargas descomprime el archivo para luego clocarlo en disco local `**C:**`, en la raiz de tu PC
![ruta de colocacion del archivo tomcat](ResourcesREADME/ubicacionTomcat.png)
---
### Abrir con vscode
Al abrir `**VSCODE**` junto con el proyecto 
![abrir vscode como el proyecto](ResourcesREADME/abrirVscode.png)
...
**TOMCAT:**
![extension Tomcat](ResourcesREADME/extensionTomcat.png)
**JAVA**
![extension java](ResourcesREADME/extensionJava.png)
